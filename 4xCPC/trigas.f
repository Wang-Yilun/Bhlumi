!      This code dates probably from 1990-91
!      TRIGAS0 is simplistic BARE trigger
!      TRIGAS1 is idealized LCAL with phi sectors used in TH-6118 (1991)
!      TRIGAS2 is realistic ALEPH LCAL trigger (from Bolek Pietrzyk)
!      DSATACC is realistic DEPLHI VSAT trigger (from Mogens Dam an Alex Read)
