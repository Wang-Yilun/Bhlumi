...
! Sophisticated analysis program
...
! Read initial (root) random number seed          
         ...
         write(6,   *) 'Bhldem2: ijklin,ntotin,ntot2n= ', ijklin,ntotin,ntot2n
         write(nout,*) 'Bhldem2: marini(ijklin,ntotin,ntot2n)'
         write(nout,*) 'Bhldem2: ijklin,ntotin,ntot2n= ', ijklin,ntotin,ntot2n
...
!-------------------------------------------------------!
      ...
      DO LOOP=1,10000000 
        DO IGROUP =1,NGROUP
          ...
          IF(IEV.LE. 8) CALL DUMPS( 6)
          IF(IEV.LE. 8) CALL DUMPS(16)
!         ============================================
!         Histograming 
...
*     **********************
      ...
      IF(NEVGEN.LE. 8) write(nout,*) 'ROBOL2:  WTMOD, wtcrud = ', WTMOD, wtcrud
...
!        IF( NEVGEN .LE. 100 ) WRITE(NOUT,*) 'NEVGEN= ',NEVGEN, ' trical1 y1C = ', y1C(1),y1C(2),y1C(2)
